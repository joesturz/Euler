...
func printer(problem number: Int, solution result: (Int, Int)) {
  print("Problem \(number):")
  print("result_1: \(result.0), result_2: \(result.1)")
}
...
func printer(problem number: Int, solution result: String) {
  print("Problem \(number): \(result)")
}
